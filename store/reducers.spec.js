...
describe('测试 reducers', function () {
  ...
  it('测试增加TODO', function () {
    ...
    expect(reducers(INIT_STATE, {type: actionTypes.ADD_TODO, todo})).toEqual([...INIT_STATE, todo]);
  });

  it('测试删除TODO', function () {
    expect(reducers(INIT_STATE, {type: actionTypes.DEL_TODO, id: 2})).toEqual([{id: 1, text: '1', completed: false}]);
  });

  it('测试切换TODO', function () {
    let todo = {id: 3, text: '3', completed: false};
